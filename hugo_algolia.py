...
# fill them
APPLICATION_ID = 'QTJ6FX8RSW'
SEARCH_ONLY_API_KEY = '7d7eba503e8260e115e3f9a6a716baaf'
INDEX_NAME = 'kalyan-blog'
...
def update_index_of_mysite():
    # your json filename
    filename = 'public/kalyan-blog.json'
    rows = json.load(open(filename, encoding="utf8"))
